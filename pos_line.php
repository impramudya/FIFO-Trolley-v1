...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <header class="header-desktop3 d-none d-lg-block">
            <div class="col-md-12">
                ...
                <div class="col-md-8" style="float: left;"> <br>
                    <h2 class="title-1" style="text-align:center;color:white;">FIFO TROLLEY - PRODUKSI LINE RING GEAR
                        1-2</h2>
        ...
        <div class="page-content--bgf7">
                        ...
                        <div class="row">
                            <div class="col-md-8" style="max-width: 53%; !important;">
                                <div class="row">
                                    ...
                                    where t2.kd_line = 'L918A' and t1.date_time = (select max(date_time) from t_trans_fifo_trolley where rfid_tag = t1.rfid_tag)
                                ...
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <tbody>
                                            <?php
                                            include('configSql.php');
                                            $sql = "SELECT * FROM t_list_fifo_prod_trolley WHERE status = 0 AND kd_line ='L918A' ORDER BY created_date;";
            ...
            WHERE tmft.partname = '$partname' AND tsf.current_position = 'store_wip' AND tmft.kd_line = 'L918A';";
                                            ...
                                            <table class="table table-borderless table-striped table-earning">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "                                                       
                                                        ...
                                                        left join t_mst_fifo_trolley tmft
                                                        on tsf.rfid_tag = tmft.rfid_tag
                                                        where tmft.kd_line = 'L918A' and tmft.partname = 'D09E, D41E'                                                       
                                                        union 
    ...
    <script>
        function showPopup(model, count_fill, count_empty) {
            ...
            var url;
            if (count_fill !== "") {
                url = "GetPopupData.php?type=fill&model=" + encodeURIComponent(model);
            } else {
                url = "GetPopupData.php?type=empty&model=" + encodeURIComponent(model);
            }
