...
<body class="animsition">
        ...
        <header class="header-desktop3 d-none d-lg-block">
            <div class="col-md-12">
                ...
                <div class="col-md-8" style="float: left;"> <br>
                    <h2 class="title-1" style="text-align:center;color:white;">FIFO TROLLEY - STORE FINISH PART</h2>
            ...
            <div class="container" style="max-width:1500px !important;">
                ...
                <div id='divData1'>
                    <section class="statistic statistic2" style="padding-top:15px;">
                        ...
                        <div class="row">
                            <!-- <div class="col-md-12" style="max-width: 60%; !important;">   -->
                            <!--  <div class="row">     -->
                            <?php
                            $i = 0;
                            ...
                            $sql2 = "select t1.id, t1.rfid_tag, t1.date_time, t1.`position`, t2.color,t2.no_trolley, t2.partname from t_trans_fifo_trolley t1
                                    ...
                                    where t1.date_time = (select max(date_time) from t_trans_fifo_trolley where rfid_tag = t1.rfid_tag)
                                    and t1.rfid_tag in (select rfid_tag as rfid_tag from t_status_fifo where current_position ='line_rg')
                            ...
                            while ($row = mysqli_fetch_assoc($stmt)) {
                                ...
                                echo " <div class='col-md-12' style='flex:0 0 40% !important;max-width:20% !important;'>";
                                echo " <div class='card'>";
                                if ($row['color'] == 'GREEN') {
                                        ...
                                        <div class="table-responsive table--no-card m-b-40">
                                            <table class="table table-borderless table-striped table-earning">
                                                ...
                                                <tbody>
                                                    ...
                                                    include('configSql.php');
                                                    $sql = "                                                       
                                                        select 'D40D, D80N' as model, sum(case when tsf.current_position = 'store_wip' then 1 else 0 END) as count_empty,
                                                        ...
                                                        where tmft.partname = 'D40D, D80N'
                                                        union                                                    
                                                        select 'D09E, D41E',sum(case when tsf.current_position = 'store_wip' then 1 else 0 END) as count_empty,
                                                        sum(case when tsf.current_position = 'line_rg' then 1 else 0 END) as count_fill
                                                        from t_status_fifo tsf
                                                        left join t_mst_fifo_trolley tmft
                                                        on tsf.rfid_tag = tmft.rfid_tag
                                                        where tmft.partname = 'D09E, D41E'                                                       
                                                        union 
                                                        select 'D63D',sum(case when tsf.current_position = 'store_wip' then 1 else 0 END) as count_empty,
                                                        sum(case when tsf.current_position = 'line_rg' then 1 else 0 END) as count_fill
                                                        from t_status_fifo tsf
                                                        left join t_mst_fifo_trolley tmft
                                                        on tsf.rfid_tag = tmft.rfid_tag
                                                        where tmft.partname = 'D63D'
                                                        union 
    ...
    <script>
        function showPopup(model, count_fill, count_empty) {
            ...
            var url;
            if (count_fill !== "") {
                url = "GetPopupDataStoreWip.php?type=fill&model=" + encodeURIComponent(model);
            } else {
                url = "GetPopupDataStoreWip.php?type=empty&model=" + encodeURIComponent(model);
            }
